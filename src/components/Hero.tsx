  ...
  return (
    <div className="w-full items-center mt-[10%]  flex flex-col  space-y-16">
      <div className=" flex lg:flex-row-reverse flex-col">
        <p className="font-normal font-Kufam ml-[20px]  text-[16px] lg:!min-w-[489px] lg:min-h-[96px] leading-[24px] text-[#fff] !max-w-[333px] !max-h-[144px]">
        ...
        <h2 className="text-[24px]  lg:text-[80px] lg:!min-w-[990px] lg:mr-[10%] lg:mt-16 lg:!min-h-[218px] lg:leading-[109.12px] font-black font-Nunito leading-[32px] !max-w-[292px] !max-h-[66px] text-[#D5FF40]">
          FULL-STACK <br />  ETHEREUM DEVELOPER.
        </h2>
      </div>
